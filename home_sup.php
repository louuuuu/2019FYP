                  ...
                  <div class="card-body">
                    <div class="d-sm-flex align-items-center mb-4">
                        <div style="width: 900px;">
                            <h4 class="card-title">Student Table</h4> </div>
                        <div class="template-demo">
                            <button type="button" class="btn btn-dark btn-rounded btn-fw"><a href="addstu.php" style="color: white;">Add Students</a></button></div>
                       </div></div>
...
while($row = mysqli_fetch_array($result)){
    ...
    echo"<td><a href=update_sup.php?id=" . $row["id"] . ">Update</a></td>";
    echo"<td><a href=deletestu.php?id=" . $row["id"] . ">Delete</a></td>";
    echo"</tr>";
}
    ?>            
