...
if (isset($_POST['submit'])) {
    ...
    // 2. Do a query (Select all line)
    $query  = "INSERT INTO feedback(username, content)";
    $query .= "VALUES ('$username', '$content')";
 
    mysqli_query($connection, $query);

    echo "<script>alert('Added successful!!');window.location.href='feedback_sup.php';</script>";
    //echo $query;
}
         ...
         <div class="container">
            <div class="row" style="flex-wrap: wrap; height: 70px; ">
              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <form class="forms-sample" action="feedback_sup.php" method="post">
