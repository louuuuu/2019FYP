...
if (isset($_POST["submit"])) {
    ...
    $query  = "INSERT INTO user(username, password, gender, level, profession)";
    $query .= "VALUES ('$username', '$password', '$gender', '$level', '$profession')";
 
    mysqli_query($connection, $query);
    
    echo "<script>alert('Add successful!!');window.location.href='home_ad.php';</script>";
    //echo $query;
}
?>
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <form class="forms-sample" action="adduser.php" method="post">
                      ...
                      <div class="form-group">
                        <label for="exampleSelectGender">Profession</label>
                      ...
                      <button class="btn btn-light"><a href="home_ad.php">Cancel</a></button>
                    </form>
                  </div>
                </div>
              </div>
