...
if (isset($_POST["submit"])) {
    ...
    // 2
    $query  = "INSERT INTO student(stu_name, gender, major, grade)";
    $query .= "VALUES ('$stu_name', '$gender', '$major', '$grade')";
 
    mysqli_query($connection, $query);
    
    echo "<script>alert('Add successful!!');window.location.href='home_sup.php';</script>";
   // echo $query;
}
?>
            ...
            <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <form class="forms-sample" action="addstu.php" method="post">
                        <input type="hidden" name="id" value="<?php echo $id; ?>">
                      <div class="form-group">
                        <label for="exampleInputName1">Name</label>
                        <input type="text" class="form-control" name="stu_name" placeholder="Name">
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        <label for="exampleInputPassword4">Major</label>
                      ...
                      <button class="btn btn-light"><a href="home_sup.php">Cancel</a></button>
                    </form>
                  </div>
                </div>
              </div>
