                  ...
                  <div class="card-body">
                    <div class="d-sm-flex align-items-center mb-4">
                        <div style="width: 900px;">
                            <h4 class="card-title">Users Table</h4> </div>
                        <div class="template-demo">
                            <button type="button" class="btn btn-dark btn-rounded btn-fw"><a href="adduser.php" style="color: white;">Add User</a></button></div>
                       </div></div>
                      ...
                      <thead>
                          <tr>
                            ...
                            <th class="font-weight-bold">Profession</th>
