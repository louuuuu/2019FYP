      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          <button id="sidebarToggleTop" class="btn btn-link d-md-none rounded-circle mr-3">
            ...
            <div class="header" style="color: black; font-size: 30px;height: 50px;"> News
            </div>
          <!-- Topbar Navbar -->
                  ...
                  <div class="card-body">
                    <div class="d-sm-flex align-items-center mb-4">
                        ...
                        <div class="template-demo">
                            <button type="button" class="btn btn-dark btn-rounded btn-fw"><a href="addnews.php" style="color: white;">Distribute News</a></button></div>
                    </div>
