...
if (isset($_POST["submit"])) {
    ...
    echo "<script>alert('Published successful!!');window.location.href='news_ad.php';</script>";
    //echo $query;
}
?>
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Distribute news</h4>

                    <form class="forms-sample" action="addnews.php" method="post">
                      ...
                      <button class="btn btn-light"><a href="news_ad.php">Cancel</a></button>
                    </form>
                  </div>
                </div>
              </div>
