...
if (isset($_POST["submit"])) {
    ...
    // 2
    $query  = "INSERT INTO mark(assessor, module, ddl, student, mark)";
    $query .= "VALUES ('$assessor', '$module', '$ddl', '$student', '$mark' )";
 
    mysqli_query($connection, $query);
    
    echo "<script>alert('Published successful!!');window.location.href='score_sup.php';</script>";
    //echo $query;
}
?>
      ...
      <div id="content">
        ...
        <!-- Begin Page Content -->
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Add Mark</h4>

                    <form class="forms-sample" action="addmark.php" method="post">
                        <input type="hidden" name="id" value="<?php echo $id; ?>">
                      <div class="form-group">
                        <label for="exampleInputName1">Assessor</label>
                        <input type="text" class="form-control" name="assessor" placeholder="Supervisor">
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        <label for="exampleSelectGender">Deadline</label>
                        <input type="text" class="form-control" name="ddl" placeholder="YYYY-MM-DD 00:00:00">
                      </div>
                      ...
                      <div class="form-group">
                        <label for="exampleSelectGender">Mark</label>
                        <input type="tinyint" class="form-control" name="mark" placeholder="0-100">
                      </div>                        
                        


                      <button type="submit" name="submit" class="btn btn-primary mr-2">Submit</button>
                      <button class="btn btn-light"><a href="score_sup.php">Cancel</a></button>
                    </form>
                  </div>
                </div>
              </div>
